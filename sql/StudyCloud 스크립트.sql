...
CREATE TABLE RESERVATION (
	...
	MEM_ID	VARCHAR2(20)		NOT NULL,
	RSV_METHOD	VARCHAR2(4)	DEFAULT 'card'	NOT NULL,
	RSV_PAY_DATE	TIMESTAMP	DEFAULT SYSTIMESTAMP	NULL,
	RSV_AMOUNT	NUMBER		NULL,
	RSV_STATUS	NUMBER		NULL
);
COMMENT ON COLUMN RESERVATION.RSV_NUM  IS '주문번호';
COMMENT ON COLUMN RESERVATION.RSV_DATE  IS '예약날짜';
COMMENT ON COLUMN RESERVATION.RSV_PERSON  IS '예약인원';
COMMENT ON COLUMN RESERVATION.MEM_ID  IS '아이';
COMMENT ON COLUMN RESERVATION.RSV_METHOD  IS '결제수단';
COMMENT ON COLUMN RESERVATION.RSV_PAY_DATE  IS '결제시간';
COMMENT ON COLUMN RESERVATION.RSV_AMOUNT  IS '총금액';
COMMENT ON COLUMN RESERVATION.RSV_STATUS  IS '주문상태(결제시1 취소시 0)';
...
ALTER TABLE CANCEL ADD CONSTRAINT FK_RESERVATION_TO_CANCEL_1 FOREIGN KEY (
	RSV_NUM
)
REFERENCES RESERVATION (
	RSV_NUM
...
CREATE TABLE PROTIME (
	PRO_USE_TIME	DATE		NOT NULL,
	PRO_NUM	NUMBER		NOT NULL,
	PRO_PRICE	NUMBER		NOT NULL,
	RSV_NUM	VARCHAR2(30)		NULL
);
COMMENT ON COLUMN PROTIME.PRO_USE_TIME  IS '사용시간';
COMMENT ON COLUMN PROTIME.PRO_NUM  IS '상품번호';
COMMENT ON COLUMN PROTIME.PRO_PRICE  IS '가격(시간당)';
COMMENT ON COLUMN PROTIME.RSV_NUM  IS '주문번호';
...
ALTER TABLE PROTIME ADD CONSTRAINT FK_RESERVATION_TO_PROTIME_1 FOREIGN KEY (
	RSV_NUM
)
REFERENCES RESERVATION (
	RSV_NUM
...
CREATE TABLE SNS (
	...
	SNS_CONNECT_DATE	DATE	DEFAULT SYSDATE	NOT NULL,
...
COMMENT ON COLUMN MEMBER_ROOM.ROOM_NUM  IS '방번호';
...
COMMENT ON COLUMN CHAT.ROOM_NUM  IS '방번호';
