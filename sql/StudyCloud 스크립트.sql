...
COMMENT ON COLUMN RESERVE.MEM_ID  IS '아이';
COMMENT ON COLUMN RESERVE.RSV_METHOD  IS '결제수단';
COMMENT ON COLUMN RESERVE.RSV_PAY_DATE  IS '결제시간';
...
COMMENT ON COLUMN SNS.SNS_ID  IS '아이디';
