        ...
        <nav class="navbar navbar-default ">
            <div class="container">
                ...
                <div class="navbar-header">
                	...
                	<a class="navbar-brand" href="index.html">Study Cloud</a>
                </div>
                ...
                <div class="collapse navbar-collapse yamm" id="navigation">
                    ...
                    <ul class="main-nav nav navbar-nav navbar-right">
                        ...
                        <li class="wow fadeInDown" data-wow-delay="0.2s"><a class="" href="properties.html">contact</a></li>
                        <li class="wow fadeInDown" data-wow-delay="0.3s"><a class="" href="property.html">chat</a></li>
                ...
                <div class="row">
                    <div class="proerty-th">
                        ...
                        <div class="col-sm-6 col-md-3 p0">
                            <div class="box-two proerty-item">
                                <div class="item-thumb">
                                    <a href="property-2.html" ><img src="<%=request.getContextPath() %>/resources/sneat/assets/img/demo/property-2.jpg"></a>
                                </div>
                                <div class="item-entry overflow">
                        ...
                        <div class="col-sm-6 col-md-3 p0">
                            <div class="box-two proerty-item">
                                <div class="item-thumb">
                                    <a href="property-3.html" ><img src="<%=request.getContextPath() %>/resources/sneat/assets/img/demo/property-3.jpg"></a>
                        ...
                        <div class="col-sm-6 col-md-3 p0">
                            <div class="box-two proerty-item">
                                <div class="item-thumb">
                                    <a href="property-1.html" ><img src="<%=request.getContextPath() %>/resources/sneat/assets/img/demo/property-4.jpg"></a>
                        ...
                        <div class="col-sm-6 col-md-3 p0">
                            <div class="box-two proerty-item">
                                <div class="item-thumb">
                                    <a href="property-3.html" ><img src="<%=request.getContextPath() %>/resources/sneat/assets/img/demo/property-2.jpg"></a>
                                </div>
                                <div class="item-entry overflow">
                                    <h5><a href="property-3.html" >Super nice villa </a></h5>
                                    <div class="dot-hr"></div>
                        ...
                        <div class="col-sm-6 col-md-3 p0">
                            <div class="box-two proerty-item">
                                <div class="item-thumb">
                                    <a href="property-2.html" ><img src="<%=request.getContextPath() %>/resources/sneat/assets/img/demo/property-4.jpg"></a>
                                </div>
                                <div class="item-entry overflow">
                                    <h5><a href="property-2.html" >Super nice villa </a></h5>
                                    <div class="dot-hr"></div>
                            ...
                            <div id="testimonial-slider">
                                <div class="item">
                                    ...
                                    <div class="client-face wow fadeInRight" data-wow-delay=".9s"> 
                                        <img src="<%=request.getContextPath() %>/resources/sneat/assets/img/client-face1.png" alt="">
                                    </div>
                                </div>
                                <div class="item">
                                    <div class="client-text">                                
                                    ...
                                    <div class="client-face">
                                        <img src="<%=request.getContextPath() %>/resources/sneat/assets/img/client-face2.png" alt="">
                                    </div>
                                </div>
                                <div class="item">
                                    <div class="client-text">                                
