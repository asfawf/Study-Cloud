						...
						<div class="col-md-12 col-xs-12 login-blocks" name="sampleForm" id="sampleForm">
							<form action="updateajax" name="sampleForm" method="post">
								...
								<div class="form-group"
									...
									<input type="tel" class="form-control" id="memPhone" name="memPhone" maxlength="13" value="${mv.memId}" style="border:none ; border-bottom: solid; border-color: #f6f6f6;"> 
								...
								<div style="display:inline-block;  margin-left: 14%; margin-right: 8%;  width: 30%; margin-top: 30px ;">
									<button type="button"  id="Quit" class="btn btn-default" style="width: 100%; border-top: 20px;   background-color: #ffd014;">탈퇴하기</button>
								</div>
