							...
							<div id="list-type" class="proerty-th-list">
									...
									<div class="box-two proerty-item">
										<div class="item-thumb">
											<a href="property-1.html"><img
												src="<%=request.getContextPath()%>/resources/sneat/assets/img/demo/property-3.jpg"></a>
										</div>
								...
								<div class="col-md-4 p0">
									<div class="box-two proerty-item">
										<div class="item-thumb">
											<a href="property-1.html"><img
												src="<%=request.getContextPath()%>/resources/sneat/assets/img/demo/property-2.jpg"></a>
										</div>
								...
								<div class="col-md-4 p0">
									<div class="box-two proerty-item">
										<div class="item-thumb">
											<a href="property-1.html"><img
												src="<%=request.getContextPath()%>/resources/sneat/assets/img/demo/property-1.jpg"></a>
										</div>
