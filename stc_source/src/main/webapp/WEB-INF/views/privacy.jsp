            ...
            <div class="notice-slider-area" style="height: 120px;">
	            ...
	            <div class="col-md-10 col-md-offset-1">
	            	<div class="col-sm feat-list">
	            		1. 개인정보처리방침의 의의
                        <h5><b>스터디클라우드는 본 개인정보처리방침은 개인정보보호법을 기준으로 작성하되, 스터디클라우드 내에서의 이용자 개인정보 처리 현황을 최대한 알기 쉽고 상세하게 설명하기 위해 노력하였습니다.</b></h5>
						...
						<br><br>
						3. 수집한 개인정보의 이용
						<h5><b>스터디클라우드 및 스터디클라우드 관련 제반 서비스(모바일 웹/앱 포함)의 회원관리, 서비스 개발·제공 및 향상, 안전한 인터넷 이용환경 구축 등 아래의 목적으로만 개인정보를 이용합니다.</b></h5>
